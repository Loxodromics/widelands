...
//
// WP-16c's water-layer dither threshold takes NO row here, the same way dither grain does not: it
// is a static void-and-cluster *texture* (u_blue_noise, data/shaders/blue_noise_64.png), sampled
// by cell index, and never enters the simplex domain this table exists to decorrelate.
