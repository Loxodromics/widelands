...
private:
	...
	/// The --renderer value ("gl21", "glcore" or "vulkan"), validated at parse
	/// time. CLI-only on purpose: a backend that fails to initialize must not
	/// linger in the config file (WP-3 of the renderer modernization plan).
